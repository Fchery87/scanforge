...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-xl border border-border glow-wire">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "sticky top-0 z-10 bg-surface-elevated/80 backdrop-blur-sm [&_tr]:border-b [&_tr]:border-border",
      className
    )}
    {...props}
  />
