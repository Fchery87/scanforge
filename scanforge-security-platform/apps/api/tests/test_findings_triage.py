...
# Repository-wide absence behavior was replaced by scope-safe ordered-series
# disappearance (R03 D2/D3/D7).  Service-level regressions live in
# tests/test_findings_disappearance_scope.py and the pure rules in
# tests/test_finding_lifecycle_policy.py.
